describe('Validar o endpoint /planets', () => {
  it('Validar o método GET', () => {
    cy.request('/planets/').then(response => {
      ...
      expect(response.body.next).to.include('https://swapi.dev/api/planets/?page=')
      ...
      expect(response.body.results[0].residents[0]).to.include('https://swapi.dev/api/people/')
      ...
      expect(response.body.results[0].url).to.include('https://swapi.dev/api/planets/')
    })
  })
})